...
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "Release tagging with the ROS 2 overlay")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "temporary local lightweight")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "generate_version\\.sh --sync-ros2")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "final annotated tag")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "git push --atomic")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "GitHub UI")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "strict version check")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "source archive")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/versioning.md" "CPackSourceConfig\\.cmake")
...
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/CMakeLists.txt" "\\*/doc/developments/\\*")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/CMakeLists.txt" "doc/reports")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/CMakeLists.txt" "\\*/doc/reports/\\*")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/template_usage.md" "tailor_template_cleanup.sh")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/template_usage.md" "--project-namespace my_project")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/bootstrap_prompts.md" "--project-namespace <cpp_namespace>")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/template_usage.md" "build_linux\\.yml\\.tpl")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/template_usage.md" "build_linux_cuda\\.yml\\.tpl")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/template_usage.md" "docs_pages\\.yml\\.tpl")
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/template_usage.md" "build_ros2_overlay\\.yml\\.tpl")
...
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/doc/ros2_overlay.md" "--project-namespace my_project")
...
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/README.md" "--project-namespace my_project")
...
_assert_matches("${TEST_TEMPLATE_SOURCE_DIR}/tailor_template_cleanup.sh" "--project-namespace <identifier>")
...
_assert_matches("${_pages_workflow}" "github.ref == format\\('refs/heads/\\{0\\}', github.event.repository.default_branch\\)")
